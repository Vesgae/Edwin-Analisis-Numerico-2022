...
e = int( sys.argv[ 3 ] )
s = int( sys.argv[ 4 ] )
#this arg is for selection of protocol 2 wich it's option is 0 or protocol 3 wich it's option is -1
op =int( sys.argv[ 5 ] )
...
#This is the new funcionality for making the program work with the other two protocols
try:
  if op == -1:
    input_sequence.sort()
    input_sequence = list(reversed(input_sequence))
  elif op == 0:
    input_sequence.sort()
except Exception as e:
  print("Sigue proceso experimental 1")
# end for
